...
public class Contabilidad {
    ...
    public static JSONObject puntoVentaTipoPago(String key_punto_venta, String key_tipo_pago, String key_moneda) {
        ...
        for (String key : resp.keySet()) {
            JSONObject item = resp.getJSONObject(key);
            if (item.getString("key_tipo_pago").equals(key_tipo_pago)
                    && item.getString("key_moneda").equals(key_moneda)) {
                return item;
            }
        }
        return resp;
    ...
    public static void ingreso(JSONObject obj, ConectInstance conectInstance) throws Exception {
        if (obj.getJSONObject("data").getDouble("monto") <= 0)
        ...
        if (caja_detalle.has("key_comprobante") && !caja_detalle.isNull("key_comprobante")) {
            ...
            obj.put("error", "El asiento ya fue generado anteriormente con el codigo: "
                    + caja_detalle.getString("codigo_comprobante"));
            return;
        }
        ...
        comprobante.put("descripcion",
                "Caja ingreso de efectivo: " + obj.getJSONObject("data").getString("descripcion"));
    ...
    public static void caja_cierre(JSONObject obj) throws Exception {
        ...
        // comprobante.put("descripcion", "Cierre de
        // caja"+obj.getJSONObject("data").getString("descripcion"));
        // }else{
        ...
        // JSONArray puntoVentaTipoPagoMontos =
        // Caja.getMontoCajaTipoPago(obj.getJSONObject("data").getString("key"));
        // JSONObject puntoVentaTipoPagos
        // =Contabilidad.puntoVentaTipoPago(obj.getJSONObject("data").getString("key_punto_venta"),null);
        // JSONObject puntoVentaTipoPagos = obj.getJSONObject("punto_venta_tipo_pago");
        // JSONObject puntoVentaTipoPago;

        // cuenta contable caja
        // String keyCuentaContableCaja =
        // obj.getJSONObject("data").getString("key_cuenta_contable");
        ...
        // puntoVentaTipoPago =
        // puntoVentaTipoPagos.getJSONObject(JSONObject.getNames(puntoVentaTipoPagos)[i]);
        ...
        // //keyCuentaContableBanco =
        // puntoVentaTipoPago.getString("key_cuenta_contable");
        ...
        // //det.put("glosa", "Cierre de caja
        // "+puntoVentaTipoPago.getString("key_tipo_pago"));
        // //det.put("debe", monto);
        // //detalle.put(det);
        //
        //
        ...
        // obj.getJSONObject("data").put("key_comprobante_cierre",
        // data.getJSONObject("data").getString("key"));
        // obj.getJSONObject("data").put("monto_cierre", 0);
        // obj.getJSONObject("data").put("fecha_cierre", SUtil.now());
        //
        // SPGConect.editObject("caja", obj.getJSONObject("data"));
    ...
    public static void ingreso_banco(JSONObject obj, ConectInstance conectInstance) throws Exception {
        ...
        asiento.descripcion = "Caja ingreso de bancos: " + obj.getJSONObject("data").getString("descripcion");
        asiento.observacion = obj.getJSONObject("data").getString("descripcion");
        ...
        double tipo_cambio = moneda.optDouble("tipo_cambio", 1);
        double monto_me = obj.getJSONObject("data").getDouble("monto");
        double monto = monto_me * tipo_cambio;
        ...
        asiento.setDetalle(new AsientoContableDetalle(
            caja_detalle.getString("key_cuenta_banco"),
            obj.getJSONObject("data").getString("descripcion"), 
            "haber", 
            monto, 
            monto_me, 
            tags));
        ...
        JSONObject data =  asiento.toJSON();

        JSONObject caja_detalle_ = new JSONObject();
        caja_detalle_.put("key", caja_detalle.getString("key"));
        caja_detalle_.put("codigo_comprobante", data.getString("codigo"));
        caja_detalle_.put("key_comprobante", data.getString("key"));
        caja_detalle_.put("key_moneda", moneda.optString("key", ""));
        caja_detalle_.put("tipo_cambio", moneda.optDouble("tipo_cambio", 1));

        caja_detalle.put("codigo_comprobante", data.getString("codigo"));
        caja_detalle.put("key_comprobante", data.getString("key"));
        conectInstance.editObject("caja_detalle", caja_detalle_);
    ...
    public static void egreso_efectivo(JSONObject obj, ConectInstance conectInstance) throws Exception {
        ...
        comprobante.put("fecha", obj.getJSONObject("data").getString("fecha"));
        comprobante.put("descripcion",
                "Caja egreso de efectivo: " + obj.getJSONObject("data").getString("descripcion"));
        comprobante.put("observacion", obj.getJSONObject("data").getString("descripcion"));
