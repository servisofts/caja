...
public class Recurrente {
    ...
    public final static String COMPONENT = "recurrente";

    public Recurrente(JSONObject obj, SSSessionAbstract session) {
    ...
    public static void ejecutar(JSONObject obj, SSSessionAbstract session) {
        try {
            ...
            JSONObject recurrente = getByKey(key);
            JSONObject objSend = recurrente.getJSONObject("data");
