...
public class CajaDetalleCuenta {
    public static final String COMPONENT = "caja_detalle_cuenta";
    ...
    public static void getAll(JSONObject obj, SSSessionAbstract session) {
        try {
            String consulta = "select get_all('" + COMPONENT + "', 'key_caja', '" + obj.getString("key_caja_detalle") + "') as json";
    ...
    public static boolean registrar(String key_caja_detalle, JSONArray cuentas) throws Exception{
        ...
        for (int i = 0; i < cuentas.length(); i++) {
            ...
            data.put("estado", 1);
            data.put("fecha_on", SUtil.now());
            data.put("key_caja_detalle", key_caja_detalle);
            data.put("key_cuenta_contable", cuentas.getJSONObject(i).getString("key_cuenta_contable"));
            data.put("monto", cuentas.getJSONObject(i).getDouble("monto"));
            cuentas.put(i, data);
        }
        

        SPGConect.insertArray(COMPONENT, cuentas);
